...
#include "evo_limits.h"

#include "../strings.h"


int16 Evo::invtype::GetInvTypeSize(int16 inv_type)
{
	switch (inv_type) {
...
const char* Evo::invtype::GetInvTypeName(int16  inv_type)
{
	switch (inv_type) {
...
bool Evo::invtype::IsInvTypePersistent(int16 inv_type)
{
	switch (inv_type) {
	case invtype::typePossessions:
	case invtype::typeBank:
...
const char* Evo::invslot::GetInvPossessionsSlotName(int16 inv_slot)
{
	switch (inv_slot) {
...
const char* Evo::invslot::GetInvCorpseSlotName(int16 inv_slot)
{
...
const char* Evo::invslot::GetInvSlotName(int16 inv_type, int16 inv_slot)
{
...
const char* Evo::invbag::GetInvBagIndexName(int16 bag_index)
{
